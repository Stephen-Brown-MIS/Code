...
public class Order{
    ...
    public String getStatusMessage() {
        if(this.ready) {
            ...
            return "Thank you for wiating. Your order will be ready soon.";
        }
    }   
    ...
    // Note: This time, you do not need to pass in a list of prices, because each item 
    // object in this order's items array has its own price, that you can access using a getter!
